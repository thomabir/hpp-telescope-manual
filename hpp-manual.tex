...
\Cref{tab:photometric-standard-stars} is a list of photometric standard stars that can be used for photometric calibration, as described in \cref{ssec:photometric-calibration}.
