...
To measure the number of counts in a region, you can use \texttt{astropy}'s \texttt{photutils}\footnote{https://photutils.readthedocs.io/en/stable/aperture.html} package.
